...
int main() {
  ...
  int iris1_a1 = 123, iris1_a2 = 456, iris1_a3 = 789;
    ...
    printf("Digite o primeiro atributo da iris: ");
    scanf("%d", &a1);

    printf("Digite o segundo atributo da iris: ");
    scanf("%d", &a2);

    printf("Digite o terceiro atributo da iris: ");
    scanf("%d", &a3);

    if (abs(a1 - iris1_a1) <= 5 &&
        abs(a2 - iris1_a2) <= 5 &&
        abs(a3 - iris1_a3) <= 5) {
